...
- The automated scoring system is trained locally. The technical evaluation files of each team are assessed according to the companies’ criteria and must follow the ,.6format provided by the customer.
...
![]("D:\1_1_AWS\Proposal markdown\fix_aws_diagram.drawio.png")
...
All critical paths including Authentication, Automatic Scoring, and Data Upload/Mapping will include extensive test coverage. Please refer to Appendix A for detailed test cases. (bỏ)
...
- Cognito User Pool integrated with Google OAuth 2.0.
...
- Full support for email/password login, Google OAuth, and password reset workflows.
